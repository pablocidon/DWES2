...
echo "<h1>cregistro.php</h1>";
show_source("controlador/cregistro.php");

echo "<h1>cWSSOAP.php</h1>";
show_source("controlador/cWSSOAP.php");
...
echo "<h1>vregistro.php</h1>";
show_source("vista/vregistro.php");

echo "<h1>vWSSOAP.php</h1>";
show_source("vista/vWSSOAP.php");
?>
<br><br>
