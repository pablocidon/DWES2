...
<nav>
    ...
    <a href="modificacionDepartamento.php"><button type="button" class="abierto" disabled><img src="images/editar.png" alt="editar">Editar</button></a>
...
try {
    ...
    <form name="input" action="<?PHP echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <input type="text" name="descripcion" value="<?php echo $datos->DescDepartamento ?>">
    ...
    if(isset($_POST['Aceptar'])) { //comprobamos si se ha pulsado aceptar
        $consulta=("UPDATE Departamento SET DescDepartamento= (\"" . $_POST['descripcion']."\") WHERE CodDepartamento = (\"" . $_POST['codigo']."\")");//Ejecutamos la consulta
